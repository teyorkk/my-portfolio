...
function CustomDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md bg-background border rounded-lg shadow-lg p-6 animate-fade-in-up">
        <button
          onClick={onClose}
...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!serviceId || !templateId || !publicKey) {
        throw new Error(
          "Email service misconfigured. Please contact me directly."
        );
      }
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-background relative scroll-mt-28 md:scroll-mt-32"
    >
      <CustomDialog
